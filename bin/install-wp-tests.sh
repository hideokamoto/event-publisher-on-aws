#!/usr/bin/env bash
# Script to install WordPress test library
# Based on WordPress core test installation script
...
install_wp() {
	...
	download https://raw.githubusercontent.com/marcochiesi/wp-cli/master/wp-config-sample.php "$WP_CORE_DIR"wp-config.php
	# remove all forward slashes in the end
	WP_CORE_DIR=$(echo $WP_CORE_DIR | sed "s:/\+$::")
	sed -i "s:dirname( __FILE__ ) . '/':'$WP_CORE_DIR/':" "$WP_CORE_DIR"/wp-config.php
